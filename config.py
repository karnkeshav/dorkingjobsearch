...
DORK_TEMPLATES = {
    ...
    "ats_discovery_ashby": 'site:ashbyhq.com (Director OR "Senior Director") AND "{keyword_1}" AND "{keyword_2}"',
    "ats_discovery_workday": 'site:myworkdayjobs.com (Director OR "Senior Director") AND "{keyword_1}" AND "{keyword_2}"',
